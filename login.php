                                    ...
                                    <div class="col-lg-9">
                                        <div>
                                            <div class="text-center">
                                                <div>
                                                    <a href="index.php" class="logo"><img src="admin/assets/images/logo-dark.png" height="20" alt="logo"></a>
                                                </div>
                                            ...
                                            <div class="p-2 mt-5">
                                                <form class="form-horizontal" action="includes/function_auth_login.php" method="post">
                                                    ...
                                                    <div class="mt-4 text-center">
                                                        <a href="auth-recoverpw.php" class="text-muted"><i class="mdi mdi-lock mr-1"></i> Forgot your password?</a>
                                                    </div>
                                                </form>
                                            </div>

                                            <div class="mt-5 text-center">
                                                <p>Don't have an account ? <a href="register.php" class="font-weight-medium text-primary"> Register </a> </p>
