                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($CHUDE_QUERY)) {
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="chude_edit.php?cd_ma=<?php echo $CD_Ma; ?>" class="mr-3 text-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="mdi mdi-pencil font-size-18"></i></a>
                                                        <a onclick="confirmDelete('<?php echo $CD_Ma; ?>');" class="text-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="mdi mdi-trash-can font-size-18"></i></a>
                                                    </td>
                                                    </tr>
                                                    <?php
                                                    $i++;
...
function confirmDelete(cd_ma) {
    swal({
        title: "Bạn chắc chứ?",
        text: "Once deleted, you will not be able to recover this record! Một khi đã xóa, thì không thể phục hồi lại được!",
        icon: "warning",
        buttons: true,
        dangerMode: true,
    })
